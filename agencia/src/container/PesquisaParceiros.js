  ...
  render() {
    ...
    return (
      <div style={{ marginBottom: 16 }}>
        ...
        <CadParceiro visible={this.state.novo || this.state.editar} parceiro={this.state.selectedRowKeys[0]} closeModal={this.closeCadModal} callbackModal={(e) => { this.setState(e) }} />

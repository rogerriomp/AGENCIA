  ...
  render() {
    ...
    return (
      <div style={{ marginBottom: 16 }}>
        ...
        <CadAnunciantes visible={this.state.novo || this.state.editar} anunciante={this.state.selectedRowKeys[0]} closeModal={this.closeCadModal} callbackModal={(e) => { this.setState(e) }} />

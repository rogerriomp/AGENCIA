  ...
  render() {
    ...
    return (
      <div style={{ marginBottom: 16 }}>
        ...
        <CadAgencia visible={this.state.novo || this.state.editar} agencia={this.state.selectedRowKeys[0]} closeModal={this.closeCadModal} callbackModal={(e) => { this.setState(e) }} />
